...
export function fetchPhotos(searchTerm, pageNumber) {
    return async (dispatch) => {
        ...
        try {
            const response = await fetch(`https://api.unsplash.com/search/photos?page=${pageNumber}&query=${searchTerm}&per_page=12&client_id=xrJ1LP9YOXq01I6uPbvcvNFm4A5wjJF0dJf9_AuRe3M`);
